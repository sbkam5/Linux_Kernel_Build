cmd_arch/x86/realmode/rm/regs.o := gcc -Wp,-MMD,arch/x86/realmode/rm/.regs.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -m16 -g -Os -DDISABLE_BRANCH_PROFILING -Wall -Wstrict-prototypes -march=i386 -mregparm=3 -fno-strict-aliasing -fomit-frame-pointer -fno-pic -mno-mmx -mno-sse -ffreestanding -fno-stack-protector -Wno-address-of-packed-member -mpreferred-stack-boundary=2 -D_SETUP -D_WAKEUP -I./arch/x86/boot -fno-asynchronous-unwind-tables    -DKBUILD_MODFILE='"arch/x86/realmode/rm/regs"' -DKBUILD_BASENAME='"regs"' -DKBUILD_MODNAME='"regs"' -c -o arch/x86/realmode/rm/regs.o arch/x86/realmode/rm/regs.c

source_arch/x86/realmode/rm/regs.o := arch/x86/realmode/rm/regs.c

deps_arch/x86/realmode/rm/regs.o := \
  ...
  arch/x86/realmode/rm/../../boot/regs.c \
  ...
  arch/x86/realmode/rm/../../boot/string.h \

arch/x86/realmode/rm/regs.o: $(deps_arch/x86/realmode/rm/regs.o)
