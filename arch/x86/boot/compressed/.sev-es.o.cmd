cmd_arch/x86/boot/compressed/sev-es.o := gcc -Wp,-MMD,arch/x86/boot/compressed/.sev-es.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -m64 -O2 -fno-strict-aliasing -fPIE -DDISABLE_BRANCH_PROFILING -mcmodel=small -mno-red-zone -mno-mmx -mno-sse -ffreestanding -fno-stack-protector -Wno-address-of-packed-member -Wno-pointer-sign -fmacro-prefix-map=./= -fno-asynchronous-unwind-tables -D__DISABLE_EXPORTS -Wa,-mrelax-relocations=no -include ./include/linux/hidden.h -I./arch/x86/lib/    -DKBUILD_MODFILE='"arch/x86/boot/compressed/sev-es"' -DKBUILD_BASENAME='"sev_es"' -DKBUILD_MODNAME='"sev_es"' -c -o arch/x86/boot/compressed/sev-es.o arch/x86/boot/compressed/sev-es.c

source_arch/x86/boot/compressed/sev-es.o := arch/x86/boot/compressed/sev-es.c

deps_arch/x86/boot/compressed/sev-es.o := \
  ...
  arch/x86/boot/compressed/../../lib/inat.c \
  arch/x86/boot/compressed/../../lib/inat-tables.c \
  arch/x86/boot/compressed/../../lib/insn.c \
  arch/x86/include/asm/emulate_prefix.h \
  arch/x86/boot/compressed/../../kernel/sev-es-shared.c \

arch/x86/boot/compressed/sev-es.o: $(deps_arch/x86/boot/compressed/sev-es.o)
