cmd_arch/x86/kernel/relocate_kernel_64.o := gcc -Wp,-MMD,arch/x86/kernel/.relocate_kernel_64.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -fmacro-prefix-map=./= -D__ASSEMBLY__ -fno-PIE -m64 -DCONFIG_X86_X32_ABI -Wa,-gdwarf-2 -DCC_USING_FENTRY    -c -o arch/x86/kernel/relocate_kernel_64.o arch/x86/kernel/relocate_kernel_64.S

source_arch/x86/kernel/relocate_kernel_64.o := arch/x86/kernel/relocate_kernel_64.S

deps_arch/x86/kernel/relocate_kernel_64.o := \
...
arch/x86/kernel/relocate_kernel_64.o: $(deps_arch/x86/kernel/relocate_kernel_64.o)
