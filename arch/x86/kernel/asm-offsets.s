	.file	"asm-offsets.c"
# GNU C89 (Ubuntu 10.2.0-13ubuntu1) version 10.2.0 (x86_64-linux-gnu)
...
# -fconserve-stack -fcf-protection=none -fverbose-asm
...
.ascii "->TASK_stack_canary $2256 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
