cmd_arch/x86/entry/vdso/vgetcpu.o := gcc -Wp,-MMD,arch/x86/entry/vdso/.vgetcpu.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -mno-avx -m64 -falign-jumps=1 -falign-loops=1 -mno-80387 -mno-fp-ret-in-387 -mpreferred-stack-boundary=3 -mskip-rax-setup -mtune=generic -mno-red-zone -mcmodel=kernel -DCONFIG_X86_X32_ABI -Wno-sign-compare -fno-asynchronous-unwind-tables -fno-jump-tables -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-address-of-packed-member -O2 -fno-allow-store-data-races -Wframe-larger-than=1024 -fstack-protector-strong -Wno-unused-but-set-variable -Wimplicit-fallthrough -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -gsplit-dwarf -gdwarf-4 -mrecord-mcount -mfentry -DCC_USING_FENTRY -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -fcf-protection=none -Wno-packed-not-aligned -mcmodel=small -fPIC -O2 -fasynchronous-unwind-tables -m64 -gsplit-dwarf -gdwarf-4 -fno-stack-protector -fno-omit-frame-pointer -foptimize-sibling-calls -DDISABLE_BRANCH_PROFILING -DBUILD_VDSO -mindirect-branch=thunk-inline -mindirect-branch-register    -DKBUILD_MODFILE='"arch/x86/entry/vdso/vgetcpu"' -DKBUILD_BASENAME='"vgetcpu"' -DKBUILD_MODNAME='"vgetcpu"' -c -o arch/x86/entry/vdso/vgetcpu.o arch/x86/entry/vdso/vgetcpu.c

source_arch/x86/entry/vdso/vgetcpu.o := arch/x86/entry/vdso/vgetcpu.c

deps_arch/x86/entry/vdso/vgetcpu.o := \
  ...
  arch/x86/include/asm/vdso/gettimeofday.h \
    ...
    $(wildcard include/config/hyperv/timer.h) \
...
arch/x86/entry/vdso/vgetcpu.o: $(deps_arch/x86/entry/vdso/vgetcpu.o)
