...
#define PV_CPU_swapgs 264 /* offsetof(struct paravirt_patch_template, cpu.swapgs) */
...
#define TASK_stack_canary 2256 /* offsetof(struct task_struct, stack_canary) */
...
#define PV_IRQ_irq_disable 304 /* offsetof(struct paravirt_patch_template, irq.irq_disable) */
#define PV_IRQ_irq_enable 312 /* offsetof(struct paravirt_patch_template, irq.irq_enable) */
#define PV_CPU_iret 256 /* offsetof(struct paravirt_patch_template, cpu.iret) */
#define PV_MMU_read_cr2 384 /* offsetof(struct paravirt_patch_template, mmu.read_cr2) */
