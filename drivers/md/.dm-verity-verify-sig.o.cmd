...
deps_drivers/md/dm-verity-verify-sig.o := \
  ...
  drivers/md/dm-verity-verify-sig.h \
    $(wildcard include/config/dm/verity/verify/roothash/sig.h) \

drivers/md/dm-verity-verify-sig.o: $(deps_drivers/md/dm-verity-verify-sig.o)
