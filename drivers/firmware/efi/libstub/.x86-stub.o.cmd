cmd_drivers/firmware/efi/libstub/x86-stub.o := gcc -Wp,-MMD,drivers/firmware/efi/libstub/.x86-stub.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/10/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -mcmodel=small -m64 -D__KERNEL__ -fPIC -fno-strict-aliasing -mno-red-zone -mno-mmx -mno-sse -fshort-wchar -Wno-pointer-sign -Wno-address-of-packed-member -fno-asynchronous-unwind-tables -Os -DDISABLE_BRANCH_PROFILING -include ./include/linux/hidden.h -D__NO_FORTIFY -ffreestanding -fno-stack-protector -D__DISABLE_EXPORTS    -DKBUILD_MODFILE='"drivers/firmware/efi/libstub/x86-stub"' -DKBUILD_BASENAME='"x86_stub"' -DKBUILD_MODNAME='"x86_stub"' -c -o drivers/firmware/efi/libstub/x86-stub.o drivers/firmware/efi/libstub/x86-stub.c

source_drivers/firmware/efi/libstub/x86-stub.o := drivers/firmware/efi/libstub/x86-stub.c

deps_drivers/firmware/efi/libstub/x86-stub.o := \
    $(wildcard include/config/apple/properties.h) \
...
drivers/firmware/efi/libstub/x86-stub.o: $(deps_drivers/firmware/efi/libstub/x86-stub.o)
